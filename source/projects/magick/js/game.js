...
window.GameConstants = {
  Fireball: {
    size: window.wizardMain.fireballSize || 24,
    speed: window.wizardMain.getFireballSpeed || function (movingLeft) {
      return movingLeft ? 2 : 5;
    }
  },
  Wizard: {
    speed: window.wizardMain.wizardSpeed || 2,
    width: window.wizardMain.wizardWidth || 61,
    getHeight: window.wizardMain.getWizardHeight || function (width) {
      return 1.377 * width;
    },
    getX: window.wizardMain.getWizardX || function (width) {
      return width / 3;
    },
    getY: window.wizardMain.getWizardY || function (height) {
      return height - 100;
    }
  }
};
